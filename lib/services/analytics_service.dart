// AnalyticsService - сервис для сбора и анализа статистики использования чата
//
// Ответственность:
// - Отслеживание использования моделей (количество запросов, токены)
// - Сбор данных о сессии (время, сообщения, производительность)
// - Расчет метрик эффективности моделей
// - Экспорт данных для анализа
//
// Архитектура:
// - Singleton паттерн (один экземпляр на всё приложение)
// - Хранение данных в памяти (не сохраняется в БД)
// - Сброс статистики при перезапуске приложения
//
// Использование:
// - Вызывается из ChatProvider при каждом запросе к API
// - Данные доступны через методы getStatistics(), getModelEfficiency() и т.д.
// - Используется для отображения статистики в UI (StatsScreen, ChatAnalyticsSheet)
